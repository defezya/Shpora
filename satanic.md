...
<https://github.com/defezya>

Чтобы оформить ссылкой часть текста, используется такой синтаксис: [текст](ссылка). Можно сделать всплывающую подсказку при наведении курсора. Для этого в круглых скобках после ссылки нужно поставить пробел и написать текст подсказки в кавычках.

[defezya](https://github.com/defezya) без подсказки

[defezya](https://github.com/defezya "Всплывающая подсказка") с подсказкой
...
[1]: https://github.com/defezya "Всплывающая подсказка"
[code]: https://github.com/defezya/shpora/blob/main/kz.md "обязательно прочитай!!"
